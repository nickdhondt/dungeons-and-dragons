...
function extract_item_ids() {
    ...
    $sql = $connection->query("SELECT item_id, type FROM inventory WHERE type=1 OR type=2 OR type=3 OR type=4 OR type=5 OR type=6 OR type=7 OR type=8 OR type=9 OR type=10 OR type=11");
